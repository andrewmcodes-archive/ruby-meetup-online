        ...
        <>
          ...
          <div className="relative bg-white overflow-hidden">
            <div className="relative pt-6 pb-16 md:pb-20 lg:pb-24 xl:pb-32">
                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                  <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                    ...
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      ...
                      Don&apos;t want to, or can&apos;t, go even if there are?
                      We want to bring the joy of congregating with your Ruby
                      friends to you with <strong>online Ruby meetups!</strong>
                    </p>
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    ...
                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                      If this is something you are interested in, please enter
                      your email below. Planning an online meetup (or{" "}
                      <i>_potentially_</i> a conference{" "}
                      <span role="img" aria-label="monocle face">
                        🧐
                      </span>
                      ) is a lot of work, and we would like to make sure there
                      is enough interest before moving forward!
                    </p>
                  </div>
              ...
              <FormCard setShowAlert={setShowAlert} />
            </div>
          </div>
        </>
      )}
